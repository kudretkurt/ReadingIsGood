...
namespace ReadingIsGood.ProductService.Contracts.Commands
{
    public class OrderControlCommand : ICommand
    {
        /// <summary>
        /// </summary>
        ...
        public OrderControlCommand(Guid userId, string userName, string deliveryAddress, string invoiceAddress,
